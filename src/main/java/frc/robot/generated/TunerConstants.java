...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("Caracal Canivore", "./logs/example.hoot");
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.264892578125);
